...
This repository contains documentation and code examples for the [ScoutingAPI](https://scoutingapi.com) REST API and MCP server. It is a resource hub, not a runtime service.
