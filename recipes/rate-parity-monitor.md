...
- **AI-agent skill + n8n workflow:** [rate-parity-monitor in travel-workflows](https://github.com/scoutingapi/travel-workflows) · rendered detail page: [https://scoutingapi.com/workflows/rate-parity-monitor](https://scoutingapi.com/workflows/rate-parity-monitor)
